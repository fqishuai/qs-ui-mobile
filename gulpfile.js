...
function copyUmd() {
  return gulp
    .src(['lib/umd/qs-ui-mobile.js'])
    .pipe(rename('qs-ui-mobile.compatible.umd.js'))
...
function build2xCSS() {
  return (
    gulp
      ...
      .pipe(
        replace(
          '@supports not (color: var(--qsf-color-text))',
